; Override of runtime/queries/lua/highlights.scm
; The pinned tree-sitter-lua parser does not have the `operator:` field
; that the upstream queries reference. We omit those two patterns.
